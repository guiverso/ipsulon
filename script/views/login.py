...
class Login(Window):
    def __init__(self, master: App, name: str = 'login'):
        ...
        self.entryuser = Entry(self,'username',width=40)
        self.entrypass = Entry(self,'senha',width=40)
        self.logbutton = Button(self,text='Entrar',command=self.login_callbk)
        self.creatbutton = Button(self,text='criar usuario',command=self.create_callbk,fg_color='transparent')
